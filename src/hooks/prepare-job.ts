...
import { networkCreate } from "../dockerCommands/network";
import type { ContextPorts, PrepareJobArgs } from "../interfaces";
import { writeToResponseFile } from "../utils";
...
export async function prepareJob(
	...
	// Create network
	const networkName = await networkCreate();
...
function generateResponseFile(
	...
	const response = {
		state: { network: networkName, container: null, services: [] },
		context: { container: { ports: {} }, services: [] },
		isAlpine,
	};
	if (containerMetadata) {
